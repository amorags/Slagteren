...
alter sequence customers_customer_id_seq owned by users.user_id;
...
alter sequence shoppingcart_cart_id_seq owned by shopping_cart.cart_id;
...
alter sequence passwords_password_id_seq owned by passwordhash.password_id;
